...
function Sounds.init()
    ...
    Sounds.combos = {
        love.audio.newSource("assets/KI_Sounds_Triple_Combo.mp3", "static"),
    ...
    Sounds.musicTracks = {
        love.audio.newSource("assets/sounds/POL-twin-turbo-long.mp3", "static" ),
        love.audio.newSource("assets/sounds/POL-cosmic-speedway-long.mp3", "static"),
        love.audio.newSource("assets/sounds/POL-crime-fighter-long.mp3", "static"),
        love.audio.newSource("assets/sounds/POL-galaxy-force-long.mp3", "static"),
        love.audio.newSource("assets/sounds/POL-underground-army-long.mp3", "static")
    }
    ...
    Sounds.musicBossBattle = love.audio.newSource("assets/sounds/POL-underground-army-long.mp3", "static")
...
function Sounds.skipToNextMusicTrack()
    ...
    if (Sounds.trackNumber > max) then
        Sounds.trackNumber = 1
    end
    Sounds.music:stop()
